...
namespace Support_Ticket_System.Services.ticketservices
{
    ...
    {
       Task<Ticket> CreateTicket(string title, string description, string assignTo, string statusName,string processFlowId, string userId ,string tenantname , string priority , string severity ,string TicketType,List<string> tag, List<string> category);
