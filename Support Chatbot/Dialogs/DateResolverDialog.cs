...
using global::Microsoft.Bot.Schema;
using global::Microsoft.Recognizers.Text.DataTypes.TimexExpression;
...
{
    public class DateResolverDialog : ComponentDialog
    {
        private const string PromptMsgText = "When would you like \n to open this ticket?";
        private const string RepromptMsgText = "I'm sorry, to make your ticket please enter a full date including Day Month and Year.";
